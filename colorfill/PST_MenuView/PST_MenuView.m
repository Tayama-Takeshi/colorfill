...
-(void)layoutSubviews{
    ...
    if (self.layoutType == PST_MenuViewLayoutTypeTitle) {
        ...
        self.titleLab.frame = CGRectMake(CGRectGetMaxX(self.imgView.frame) + 10, 0, self.contentView.frame.size.width - (CGRectGetMaxX(self.imgView.frame) + 10), contentViewH);
    }
